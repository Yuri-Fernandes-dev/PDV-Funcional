        ...
        if tem_tabela_itens and itens_venda:
            ...
            for item in itens_venda:
                ...
                if produto:
                    ...
                    # NOTA: A atualização do estoque é removida daqui, pois já é feita
                    # no PDVWindow.finalize_sale() através da função atualizar_estoque()
                    # Isso evita que o estoque seja reduzido duas vezes
